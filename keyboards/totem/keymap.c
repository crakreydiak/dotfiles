...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷
   ...
   KC_LSFT,   KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,      KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_BSPC,
                                  KC_ESC,  KC_TAB,   LWR_SPC,   RSE_ENT,  KC_BSPC,  KC_DEL
 ),
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷
    ...
    SNAP,LSFT(KC_GRV),  KC_TILD,  C(KC_S),  KC_PGDN,  KC_LPRN,   KC_BSLS,  KC_MINS,  KC_EQL,   KC_LBRC,  KC_RBRC,  _______,
